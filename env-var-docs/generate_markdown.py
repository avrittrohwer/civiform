...
def main():
    ...
    try:
        ...
        res = repo.update_file(path, f"Updates {config.version} server environment variable documentation", markdown, file.sha)
    except github.UnknownObjectException:
        res = repo.create_file(path, f"Adds {config.version} server environment variable documentation", markdown, branch="main")
